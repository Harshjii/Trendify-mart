  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <Image src="/placeholder.svg?height=600&width=1200" alt="Formal Collection" fill className="object-cover" />
        <div className="relative z-20 text-center maxzone-slide-up">
          <h1 className="text-6xl md:text-8xl font-black mb-4 maxzone-text-glow">FORMAL</h1>
          <p className="text-xl md:text-2xl font-light tracking-wider text-gray-300">
            ELEGANCE REDEFINED • BUSINESS READY
          </p>
        </div>
      </section>
